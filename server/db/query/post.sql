...
INSERT INTO posts (title, body, user_id, username, status, category, published_at) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING *;
...
INSERT INTO comments (user_id, username, post_id, body) VALUES ($1, $2, $3, $4) RETURNING *;
